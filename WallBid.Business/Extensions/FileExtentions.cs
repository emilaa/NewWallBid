...
namespace WallBid.Business.Extensions
{
    public static class FileExtentions
    {
        ...
        public static void DeleteImage(this string imagePath, string root, string path)
        {
            path = Path.Combine(root, path, imagePath);
